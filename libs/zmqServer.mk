...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > ".build-debug/zmqServer"
...
$(IntermediateDirectory)/src_zmqServer.cpp$(ObjectSuffix): src/zmqServer.cpp $(IntermediateDirectory)/src_zmqServer.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "src/zmqServer.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_zmqServer.cpp$(ObjectSuffix) $(IncludePath)
